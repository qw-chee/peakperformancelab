...
if st.session_state.scenario is None:
    ...
    <div class='pixel-card' style='text-align: center;'>
        <h3 class='pixel-title' style='margin-bottom: -5px; font-size: clamp(1.2rem, 2vw, 1.6em);'>⚔️ Inner Critic Boss Fight</h3>
    ...
    <div class='pixel-card'>
        <h3 class='pixel-title' style='margin-bottom: -5px; font-size: clamp(1.2rem, 2vw, 1.5em); text-align: center;'>🎮 How to Play</h3>
