        ...
        <div class='pixel-text' style='font-size: clamp(0.9rem, 1.3vw, 1.1em);'>
            ...
            <div style='display: grid; grid-template-columns: 1fr 1fr 1fr; gap: clamp(8px, 1.2vw, 12px); margin-bottom: 0px;'>
                <div style='background: #02b322; color: white; padding: clamp(10px, 1.5vw, 15px); border-radius: clamp(4px, 0.8vw, 6px); text-align: center; border: clamp(1px, 0.2vw, 2px) solid #175dcf;'>
                    <strong style='font-size: clamp(0.9rem, 1.2vw, 1rem);'>Strong & Positive:</strong><br><small style='font-size: clamp(0.8rem, 1.1vw, 0.9rem);'>Boss loses 15 HP</small>
                </div>
                <div style='background: #ffbb00; color: white; padding: clamp(10px, 1.5vw, 15px); border-radius: clamp(4px, 0.8vw, 6px); text-align: center; border: clamp(1px, 0.2vw, 2px) solid #175dcf;'>
                    <strong style='font-size: clamp(0.9rem, 1.2vw, 1rem);'>Weak or Generic:</strong><br><small style='font-size: clamp(0.8rem, 1.1vw, 0.9rem);'>Boss loses 5 HP</small>
                </div>
                <div style='background: #da531f; color: white; padding: clamp(10px, 1.5vw, 15px); border-radius: clamp(4px, 0.8vw, 6px); text-align: center; border: clamp(1px, 0.2vw, 2px) solid #175dcf;'>
                    <strong style='font-size: clamp(0.9rem, 1.2vw, 1rem);'>Poor or Irrelevant:</strong><br><small style='font-size: clamp(0.8rem, 1.1vw, 0.9rem);'>You lose 15 HP</small>
                </div>
            </div>
        </div>
    </div>
