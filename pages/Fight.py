...
if st.session_state.scenario is None:
    ...
    <div class='pixel-card' style='text-align: center;'>
        ...
        <p class='pixel-text' style='font-size: clamp(0.9rem, 1.3vw, 1.1em); margin: 0;'>
            In times of stress, positive self-talk are words of encouragement you can say to yourself to remind you of your qualities and your ability to perservere. Using self-talk can also help you think 
