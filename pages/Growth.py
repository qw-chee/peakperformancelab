...
Format your response as a simple list with each recommendation on a new line, starting with a dash (-). Give a maximum of 4 recommendations with a maximum of 9 words each. Use a warm, conversational tone.
"""
...
if st.session_state.current_question == 0 and not st.session_state.quiz_completed:
    ...
    <div class="nature-container">
        <h3 style="color: #6e4000; font-family: 'Fredoka', cursive; font-size: 1.5em; margin-bottom: -5px; margin-top: -5px; text-align: center;">
    ...
    <div class="nature-container">
        ...
        <div style="margin: -10px 0 -20px 0;">
            <div class="response-grid">
                <div style="background: linear-gradient(135deg, #ec6b40 0%, #ff8a65 50%, #f9e79f 100%); border: 2px solid #fc6f97; border-radius: 15px; padding: 5px; text-align: center; font-family: 'Fredoka', cursive; font-weight: 600; color: white;">
                    Strongly Disagree
                </div>
                <div style="background: linear-gradient(135deg, #ec6b40 0%, #ff8a65 50%, #f9e79f 100%); border: 2px solid #fc6f97; border-radius: 15px; padding: 5px; text-align: center; font-family: 'Fredoka', cursive; font-weight: 600; color: white;">
                    Disagree
                </div>
                <div style="background: linear-gradient(135deg, #ec6b40 0%, #ff8a65 50%, #f9e79f 100%); border: 2px solid #fc6f97; border-radius: 15px; padding: 5px; text-align: center; font-family: 'Fredoka', cursive; font-weight: 600; color: white; margin-top: -5px;">
                    Agree
                </div>
                <div style="background: linear-gradient(135deg, #ec6b40 0%, #ff8a65 50%, #f9e79f 100%); border: 2px solid #fc6f97; border-radius: 15px; padding: 5px; text-align: center; font-family: 'Fredoka', cursive; font-weight: 600; color: white; margin-top: -5px;">
                    Strongly Agree
