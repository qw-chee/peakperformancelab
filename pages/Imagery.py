...
if st.session_state.current_step == 0:
    ...
    <div class="movie-container">
        ...
        <div class="movie-text">
            You will use the <strong>PETTLEP</strong> framework - 7  elements that make 
            imagery incredibly effective. Think of them as a different camera angles that makes your mental movie more realistic and powerful.
        </div>
