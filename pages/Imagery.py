...
if st.session_state.current_step == 0:
    ...
    st.markdown("""
        <h3 style="color: #FFD700; font-family: 'Sigmar', cursive; font-size: clamp(1.5rem, 2.2vw, 2em); text-align: center; letter-spacing: clamp(1px, 0.15vw, 1px); margin-bottom: -30px;">
