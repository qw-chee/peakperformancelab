...
def get_styles():
    ...
    .stApp {
        background-image: url('https://www.dropbox.com/scl/fi/gt6nkz39hyynsd8f9xsqf/growth.gif?rlkey=5xuzc57818di102ofy3x89dew&st=y9pepuas&raw=1');
...
# RESULTS PAGE
    ...
    <div class="nature-container">
        <div class="results-container">
            ...
            <h2 class="result-title" style="color: {result_data['color']};">{result_data['title']}</h2>
            <h3 class="result-title" style="color: {result_data['color']};">{result_data['subtitle']}</h3>
